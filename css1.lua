...
local FloatingButtonFrame = Instance.new("TextButton")
local Corner = Instance.new("UICorner")

FloatingButton.Name = "RayfieldFloating"
...
FloatingButtonFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
FloatingButtonFrame.BorderSizePixel = 0
FloatingButtonFrame.Size = UDim2.new(1, 0, 1, 0)
...
Shadow.ZIndex = FloatingButtonFrame.ZIndex - 1
...
Corner.Parent = FloatingButtonFrame
...
FloatingButtonFrame.InputBegan:Connect(function(input)
...
FloatingButtonFrame.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		dragging = false
	end
end)
...
local function Hide(notify: boolean?)
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 420, 0, 0)}):Play()
	...
	if FloatingButtonFrame then
		FloatingButtonFrame.Visible = true
		TweenService:Create(FloatingButtonFrame, TweenInfo.new(0.3, Enum.EasingStyle.Back), {BackgroundTransparency = 0.1}):Play()
	end
end
...
local function Maximise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = useMobileSizing and UDim2.new(0, 380, 0, 250) or UDim2.new(0, 420, 0, 380)}):Play()
...
local function Unhide()
	...
	if FloatingButtonFrame then
		TweenService:Create(FloatingButtonFrame, TweenInfo.new(0.2, Enum.EasingStyle.Back), {BackgroundTransparency = 1}):Play()
		task.wait(0.2)
		FloatingButtonFrame.Visible = false
	end
...
local function Minimise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 420, 0, 35)}):Play()
	TweenService:Create(Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 420, 0, 35)}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	task.wait(0.1)
	TweenService:Create(Main, TweenInfo.new(0.6, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Size = useMobileSizing and UDim2.new(0, 380, 0, 250) or UDim2.new(0, 420, 0, 380)}):Play()
	TweenService:Create(Main.Shadow.Image, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {ImageTransparency = 0.6}):Play()
...
-- Add floating button click event
if FloatingButtonFrame then
	FloatingButtonFrame.MouseButton1Click:Connect(function()
		if Hidden then
