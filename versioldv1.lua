	...
	FloatingButton.BackgroundColor3 = Color3.fromRGB(0, 122, 255)
	...
	FloatingCorner.Name = "FloatingCorner"
	...
	local UICorner_PresetFrame = Instance.new("UICorner")
	local PresetText = Instance.new("TextLabel")
	local PresetBeginnerButton = Instance.new("TextButton")
	local PresetSpeedButton = Instance.new("TextButton")
	local PresetProfitButton = Instance.new("TextButton")
	local PresetAFKButton = Instance.new("TextButton")
	local PresetSafeButton = Instance.new("TextButton")
	
	PresetFrame.Name = "PresetFrame"
	PresetFrame.Parent = MainListLayoutFrame
	PresetFrame.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
	PresetFrame.BorderSizePixel = 0
	PresetFrame.Size = UDim2.new(0.898, 0, 0.25, 0)
	
	UICorner_PresetFrame.Parent = PresetFrame
	
	PresetText.Name = "PresetText"
	PresetText.Parent = PresetFrame
	PresetText.BackgroundTransparency = 1
	PresetText.Position = UDim2.new(0.030, 0, 0.05, 0)
	PresetText.Size = UDim2.new(0.940, 0, 0.15, 0)
	PresetText.Font = Enum.Font.SourceSansBold
	PresetText.Text = "Quick Start Presets:"
	PresetText.TextColor3 = Color3.fromRGB(255, 255, 255)
	PresetText.TextScaled = true
	PresetText.TextXAlignment = Enum.TextXAlignment.Left
	
	-- Preset Buttons
	PresetBeginnerButton.Name = "PresetBeginnerButton"
	PresetBeginnerButton.Parent = PresetFrame
	PresetBeginnerButton.BackgroundColor3 = Color3.fromRGB(0, 150, 0)
	PresetBeginnerButton.Position = UDim2.new(0.030, 0, 0.25, 0)
	PresetBeginnerButton.Size = UDim2.new(0.18, 0, 0.15, 0)
	PresetBeginnerButton.Font = Enum.Font.SourceSansBold
	PresetBeginnerButton.Text = "Beginner"
	PresetBeginnerButton.TextColor3 = Color3.fromRGB(255, 255, 255)
	PresetBeginnerButton.TextScaled = true
	
	local UICorner_Beginner = Instance.new("UICorner")
	UICorner_Beginner.Parent = PresetBeginnerButton
	
	PresetSpeedButton.Name = "PresetSpeedButton"
	PresetSpeedButton.Parent = PresetFrame
	PresetSpeedButton.BackgroundColor3 = Color3.fromRGB(255, 100, 0)
	PresetSpeedButton.Position = UDim2.new(0.22, 0, 0.25, 0)
	PresetSpeedButton.Size = UDim2.new(0.18, 0, 0.15, 0)
	PresetSpeedButton.Font = Enum.Font.SourceSansBold
	PresetSpeedButton.Text = "Speed"
	PresetSpeedButton.TextColor3 = Color3.fromRGB(255, 255, 255)
	PresetSpeedButton.TextScaled = true
	
	local UICorner_Speed = Instance.new("UICorner")
	UICorner_Speed.Parent = PresetSpeedButton
	
	PresetProfitButton.Name = "PresetProfitButton"
	PresetProfitButton.Parent = PresetFrame
	PresetProfitButton.BackgroundColor3 = Color3.fromRGB(255, 215, 0)
	PresetProfitButton.Position = UDim2.new(0.41, 0, 0.25, 0)
	PresetProfitButton.Size = UDim2.new(0.18, 0, 0.15, 0)
	PresetProfitButton.Font = Enum.Font.SourceSansBold
	PresetProfitButton.Text = "Profit"
	PresetProfitButton.TextColor3 = Color3.fromRGB(0, 0, 0)
	PresetProfitButton.TextScaled = true
	
	local UICorner_Profit = Instance.new("UICorner")
	UICorner_Profit.Parent = PresetProfitButton
	
	PresetAFKButton.Name = "PresetAFKButton"
	PresetAFKButton.Parent = PresetFrame
	PresetAFKButton.BackgroundColor3 = Color3.fromRGB(128, 0, 128)
	PresetAFKButton.Position = UDim2.new(0.60, 0, 0.25, 0)
	PresetAFKButton.Size = UDim2.new(0.18, 0, 0.15, 0)
	PresetAFKButton.Font = Enum.Font.SourceSansBold
	PresetAFKButton.Text = "AFK"
	PresetAFKButton.TextColor3 = Color3.fromRGB(255, 255, 255)
	PresetAFKButton.TextScaled = true
	
	local UICorner_AFK = Instance.new("UICorner")
	UICorner_AFK.Parent = PresetAFKButton
	
	PresetSafeButton.Name = "PresetSafeButton"
	PresetSafeButton.Parent = PresetFrame
	PresetSafeButton.BackgroundColor3 = Color3.fromRGB(0, 100, 200)
	PresetSafeButton.Position = UDim2.new(0.79, 0, 0.25, 0)
	PresetSafeButton.Size = UDim2.new(0.18, 0, 0.15, 0)
	PresetSafeButton.Font = Enum.Font.SourceSansBold
	PresetSafeButton.Text = "🛡️ Safe"
	PresetSafeButton.TextColor3 = Color3.fromRGB(255, 255, 255)
	PresetSafeButton.TextScaled = true
	
	local UICorner_Safe = Instance.new("UICorner")
	UICorner_Safe.Parent = PresetSafeButton
	
	-- Perfect Cast Mode Frame
	local PerfectCastFrame = Instance.new("Frame")
	local UICorner_PerfectCast = Instance.new("UICorner")
	local PerfectCastText = Instance.new("TextLabel")
	local PerfectCastButton = Instance.new("TextButton")
	local PerfectCastWarna = Instance.new("Frame")
	local UICorner_PerfectCastWarna = Instance.new("UICorner")
	
	PerfectCastFrame.Name = "PerfectCastFrame"
	PerfectCastFrame.Parent = MainListLayoutFrame
	PerfectCastFrame.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
	PerfectCastFrame.BorderSizePixel = 0
	PerfectCastFrame.Size = UDim2.new(0.898, 0, 0.106, 0)
	
	UICorner_PerfectCast.Parent = PerfectCastFrame
	
	PerfectCastText.Name = "PerfectCastText"
	PerfectCastText.Parent = PerfectCastFrame
	PerfectCastText.BackgroundTransparency = 1
	PerfectCastText.Position = UDim2.new(0.030, 0, 0.216, 0)
	PerfectCastText.Size = UDim2.new(0.415, 0, 0.568, 0)
	PerfectCastText.Font = Enum.Font.SourceSansBold
	PerfectCastText.Text = "Perfect Cast Mode :"
	PerfectCastText.TextColor3 = Color3.fromRGB(255, 255, 255)
	PerfectCastText.TextScaled = true
	PerfectCastText.TextXAlignment = Enum.TextXAlignment.Left
	
	PerfectCastButton.Name = "PerfectCastButton"
	PerfectCastButton.Parent = PerfectCastFrame
	PerfectCastButton.BackgroundTransparency = 1
	PerfectCastButton.Position = UDim2.new(0.756, 0, 0.108, 0)
	PerfectCastButton.Size = UDim2.new(0.207, 0, 0.784, 0)
	PerfectCastButton.ZIndex = 2
	PerfectCastButton.Font = Enum.Font.SourceSansBold
	PerfectCastButton.Text = "OFF"
	PerfectCastButton.TextColor3 = Color3.fromRGB(255, 255, 255)
	PerfectCastButton.TextScaled = true
	
	PerfectCastWarna.Name = "PerfectCastWarna"
	PerfectCastWarna.Parent = PerfectCastFrame
	PerfectCastWarna.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
	PerfectCastWarna.BorderSizePixel = 0
	PerfectCastWarna.Position = UDim2.new(0.756, 0, 0.135, 0)
	PerfectCastWarna.Size = UDim2.new(0.204, 0, 0.730, 0)
	
	UICorner_PerfectCastWarna.Parent = PerfectCastWarna
	
	-- Analytics Frame
	local AnalyticsFrame = Instance.new("Frame")
	local UICorner_Analytics = Instance.new("UICorner")
	local AnalyticsText = Instance.new("TextLabel")
	local ShowStatsButton = Instance.new("TextButton")
	local ResetStatsButton = Instance.new("TextButton")
	
	AnalyticsFrame.Name = "AnalyticsFrame"
	AnalyticsFrame.Parent = MainListLayoutFrame
	AnalyticsFrame.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
	AnalyticsFrame.BorderSizePixel = 0
	AnalyticsFrame.Size = UDim2.new(0.898, 0, 0.15, 0)
	
	UICorner_Analytics.Parent = AnalyticsFrame
	
	AnalyticsText.Name = "AnalyticsText"
	AnalyticsText.Parent = AnalyticsFrame
	AnalyticsText.BackgroundTransparency = 1
	AnalyticsText.Position = UDim2.new(0.030, 0, 0.1, 0)
	AnalyticsText.Size = UDim2.new(0.940, 0, 0.25, 0)
	AnalyticsText.Font = Enum.Font.SourceSansBold
	AnalyticsText.Text = "Advanced Analytics:"
	AnalyticsText.TextColor3 = Color3.fromRGB(255, 255, 255)
	AnalyticsText.TextScaled = true
	AnalyticsText.TextXAlignment = Enum.TextXAlignment.Left
	
	ShowStatsButton.Name = "ShowStatsButton"
	ShowStatsButton.Parent = AnalyticsFrame
	ShowStatsButton.BackgroundColor3 = Color3.fromRGB(0, 150, 255)
	ShowStatsButton.Position = UDim2.new(0.030, 0, 0.45, 0)
	ShowStatsButton.Size = UDim2.new(0.4, 0, 0.4, 0)
	ShowStatsButton.Font = Enum.Font.SourceSansBold
	ShowStatsButton.Text = "📊 Show Stats"
	ShowStatsButton.TextColor3 = Color3.fromRGB(255, 255, 255)
	ShowStatsButton.TextScaled = true
	
	local UICorner_ShowStats = Instance.new("UICorner")
	UICorner_ShowStats.Parent = ShowStatsButton
	
	ResetStatsButton.Name = "ResetStatsButton"
	ResetStatsButton.Parent = AnalyticsFrame
	ResetStatsButton.BackgroundColor3 = Color3.fromRGB(255, 100, 100)
	ResetStatsButton.Position = UDim2.new(0.55, 0, 0.45, 0)
	ResetStatsButton.Size = UDim2.new(0.4, 0, 0.4, 0)
	...
	ResetStatsButton.TextScaled = true
	
	local UICorner_ResetStats = Instance.new("UICorner")
	UICorner_ResetStats.Parent = ResetStatsButton
	...
	local globalAutoSellEnabled = true
	...
	local function CheckAndAutoSell()
		if autoSellOnThreshold and fishCaught >= autoSellThreshold then
			pcall(function()
				if not (game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart")) then return end
	...
	-- UI MINIMIZE FUNCTIONS --
	local function MinimizeUI()
		isMinimized = true
		FrameUtama.Visible = false
		FloatingButton.Text = "📱"
		FloatingButton.BackgroundColor3 = Color3.fromRGB(255, 165, 0)
		-- Add visual feedback
		local TweenService = game:GetService("TweenService")
		local scaleUp = TweenService:Create(FloatingButton, TweenInfo.new(0.2), {Size = UDim2.new(0, 70, 0, 70)})
		local scaleDown = TweenService:Create(FloatingButton, TweenInfo.new(0.2), {Size = UDim2.new(0, 60, 0, 60)})
		scaleUp:Play()
		scaleUp.Completed:Connect(function() scaleDown:Play() end)
		NotifyInfo("UI", "Interface minimized! Click floating button to restore.")
	end
	...
	local function RestoreUI()
		...
		scaleUp:Play()
		scaleUp.Completed:Connect(function() scaleDown:Play() end)
		NotifyInfo("UI", "Interface restored!")
	end
	...
	function toggleFishing(state)
		if state == true then
			...
			-- Spawn thread AutoFishing with enhanced features
			autoFishThread = task.spawn(function()
				while _G.AutoFishing do
					pcall(function()
						...
						local timestamp = usePerfectCast and 9999999999 or (workspace:GetServerTimeNow())
						ChargeRod:InvokeServer(timestamp)
						
						local x = usePerfectCast and -1.2379989624023438 or (math.random(-1000, 1000) / 1000)
						local y = usePerfectCast and 0.9800224985802423 or (math.random(0, 1000) / 1000)
					...
					-- Use dynamic recast delay from presets
	...
	FloatingButton.InputChanged:Connect(function(input)
		if dragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
			...
			FloatingButton.Position = newPosition
		end
	end)
	...
	PresetBeginnerButton.MouseButton1Click:Connect(function()
		ApplyPreset("Beginner")
	end)

	PresetSpeedButton.MouseButton1Click:Connect(function()
		ApplyPreset("Speed")
	end)

	PresetProfitButton.MouseButton1Click:Connect(function()
		ApplyPreset("Profit")
	end)

	PresetAFKButton.MouseButton1Click:Connect(function()
		ApplyPreset("AFK")
	end)

	PresetSafeButton.MouseButton1Click:Connect(function()
		ApplyPreset("Safe")
	end)

	-- Perfect Cast Button Handler
	PerfectCastButton.MouseButton1Click:Connect(function()
		perfectCast = not perfectCast
		if perfectCast then
			safeMode = false  -- Disable safe mode when perfect cast is manually enabled
			PerfectCastButton.Text = "ON"
			PerfectCastWarna.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
		else
			PerfectCastButton.Text = "OFF"
			PerfectCastWarna.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		end
		NotifySuccess("Perfect Cast", "Perfect cast mode " .. (perfectCast and "activated" or "deactivated") .. "!")
	end)

	-- Analytics Button Handlers
	ShowStatsButton.MouseButton1Click:Connect(function()
