...
local TeleportLocations = {
    Islands = {
        ["🏝️ Moosewood"] = CFrame.new(389, 137, 264),
        ["🌊 Ocean"] = CFrame.new(1082, 124, -924),
        ["🏔️ Snowcap Island"] = CFrame.new(2648, 140, 2522),
        ["🏜️ Mushgrove Swamp"] = CFrame.new(-1817, 138, 1808),
        ["🌋 Roslit Bay"] = CFrame.new(-1442, 135, 1006),
        ["🏖️ Sunstone Island"] = CFrame.new(-934, 135, -1122),
        ["⭐ Statue Of Sovereignty"] = CFrame.new(1, 140, -918),
        ["🌙 Moonstone Island"] = CFrame.new(-3004, 135, -1157),
        ["❄️ Forsaken Shores"] = CFrame.new(-2853, 135, 1627),
        ["🎣 Ancient Isle"] = CFrame.new(5896, 137, 4516),
        ["🏛️ Keepers Altar"] = CFrame.new(1296, 135, -808),
...
-- Create buttons for each island
...
spawn(function()
    ...
    wait(3)
    NotifyInfo("🌟 Ultimate Teleportation!", "TELEPORTATION SYSTEM ACTIVE:\n15+ Islands • 10+ NPCs • 7+ Events • Player TP • Position Saving • Smart Safety Features\n\nCheck TELEPORT tab for instant travel!")
